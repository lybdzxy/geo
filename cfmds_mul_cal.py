...
his = xr.open_dataset(r'E:/testidm/fulltime/pr_day_TaiESM1_historical_r1i1p1f1_gn_full-time.nc')
mod = xr.open_dataset(r'E:/testidm/fulltime/pr_day_TaiESM1_ssp585_r1i1p1f1_gn_full-time.nc')
obs = {}  # Create an empty dictionary to store the datasets
for i in range(1960, 1980):
    filename = f'E:/I_LOVE_GEO/ERA5/{i}.nc'
    obs[i] = xr.open_dataset(filename)
...
for months in range(1,13):
    ...
    for days in range(1, num_days_in_month + 1):
         ...
         combined_data = daily_avg_precipitation_data*obs_month_data*1000
