...
for district in districts:
    for index in indices:
        data_126path = f'E:/GEO/result/new/{district}_126_{index}.xlsx'
        ...
        data_585path = f'E:/GEO/result/new/{district}_585_{index}.xlsx'
        ...
        data_obspath = f'E:/GEO/result/new/{district}_obs_{index}.xlsx'
        ...
        plt.savefig(f'E:/GEO/result/new/{district}{index}.png',dpi=600)
        plt.close()